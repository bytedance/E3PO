...
class OnDemandData(BaseData):
    ...
    def process_video(self):
        self._convert_ori_video()           # custom projection maybe used here, so contestant should implement their own method
        self._generate_chunk()              # uniform parameters will be used, contestant shouldn't modify this function
        self._generate_tile()               # custom tiling maybe used here, so contestant should implement their own method
        self._get_tile_size()               # with custom tiling, contestant should implement their own method
